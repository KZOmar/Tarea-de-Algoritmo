...
// Entrada: arregloElementos = ["Omar", "Erick", "José", "Nayeli", "Kevin"](leer), arregloMover = ["", "", "", "", ""](proceso)
...
//  nombre1="Omar"; nombre2="Erick"; nombre3="José"; nombre4="Nayeli"; nombre5="Kevin"
...
function ejercicio_15(){
    let arregloElementos = ["Omar", "Erick", "José", "Nayeli", "Kevin"];
    let arregloMover = ["", "", "", "", ""];
